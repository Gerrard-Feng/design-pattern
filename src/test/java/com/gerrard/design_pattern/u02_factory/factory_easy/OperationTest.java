...
public class OperationTest {
	...
	public void test() {
		...
		double[] vals2 = { 20, 2 };
		AbsOperation operator1 = OperationFactory3.createOperation1(OperatorEnum.OPERATOR_ADD);
		OperationSub operator2 = OperationFactory3.createOperation2(OperationSub.class);
