...
public class OperationTest {
	...
	public void test() {
		...
		double[] vals2 = { 20, 2 };
		AbsOperation operator1 = OperationFactory.createOperation1(OperatorEnum.OPERATOR_ADD);
		OperationSub operator2 = OperationFactory.createOperation2(OperationSub.class);
